    ...
    <div class="grid grid-cols-1 gap-4 md:gap-6">
        ...
        <div class="project-card p-4 sm:p-6 rounded-xl transition-all duration-300 hover:scale-[1.02] cursor-interactive shadow-lg"
            ...
            <div class="mb-3 md:mb-4">
                <h3 class="text-lg sm:text-xl font-bold mb-2 transition-colors" :class="isDark ? 'text-white' : 'text-gray-900'">Portfolio Website</h3>
            ...
            <div class="flex justify-between items-center">
                <a href="https://github.com/The-Peacemaker/portfolio" target="_blank" rel="noopener noreferrer" 
                   class="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm font-medium hover:underline transition-colors" 
                ...
                <span class="text-xs sm:text-sm font-medium transition-colors" :class="isDark ? 'text-gray-400' : 'text-gray-500'">2024</span>
            </div>
        </div>
        ...
        <div class="project-card p-4 sm:p-6 rounded-xl transition-all duration-300 hover:scale-[1.02] cursor-interactive shadow-lg"
             :class="isDark ? 'bg-gray-800 border border-gray-700 hover:border-gray-600' : 'bg-white border border-gray-200 hover:border-gray-300'">
            <div class="mb-3 md:mb-4">
                <h3 class="text-lg sm:text-xl font-bold mb-2 transition-colors" :class="isDark ? 'text-white' : 'text-gray-900'">Bug Bounty Automation Tool</h3>
                <p class="text-xs sm:text-sm transition-colors leading-relaxed" :class="isDark ? 'text-gray-300' : 'text-gray-600'">
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="text-xs sm:text-sm font-medium transition-colors" :class="isDark ? 'text-gray-400' : 'text-gray-500'">2023</span>
            </div>
        </div>
        ...
        <div class="project-card p-4 sm:p-6 rounded-xl transition-all duration-300 hover:scale-[1.02] cursor-interactive shadow-lg"
             :class="isDark ? 'bg-gray-800 border border-gray-700 hover:border-gray-600' : 'bg-white border border-gray-200 hover:border-gray-300'">
            <div class="mb-3 md:mb-4">
                <h3 class="text-lg sm:text-xl font-bold mb-2 transition-colors" :class="isDark ? 'text-white' : 'text-gray-900'">Mobile Security Scanner</h3>
                <p class="text-xs sm:text-sm transition-colors leading-relaxed" :class="isDark ? 'text-gray-300' : 'text-gray-600'">
        ...
        <div class="project-card p-4 sm:p-6 rounded-xl transition-all duration-300 hover:scale-[1.02] cursor-interactive shadow-lg"
             :class="isDark ? 'bg-gray-800 border border-gray-700 hover:border-gray-600' : 'bg-white border border-gray-200 hover:border-gray-300'">
            <div class="mb-3 md:mb-4">
                <h3 class="text-lg sm:text-xl font-bold mb-2 transition-colors" :class="isDark ? 'text-white' : 'text-gray-900'">CTF Challenge Platform</h3>
                <p class="text-xs sm:text-sm transition-colors leading-relaxed" :class="isDark ? 'text-gray-300' : 'text-gray-600'">
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="text-xs sm:text-sm font-medium transition-colors" :class="isDark ? 'text-gray-400' : 'text-gray-500'">2022</span>
            </div>
        </div>
    </div>

    <!-- Additional Projects Section -->
    <div class="mt-6 md:mt-8 pt-4 md:pt-6 border-t transition-colors" :class="isDark ? 'border-gray-700' : 'border-gray-200'">
        ...
        <div class="space-y-2.5 md:space-y-3">
            <div class="flex justify-between items-center p-3 sm:p-4 rounded-lg transition-colors" :class="isDark ? 'bg-gray-800' : 'bg-gray-50'">
                <div>
                    <h4 class="font-medium text-sm sm:text-base transition-colors" :class="isDark ? 'text-white' : 'text-gray-900'">Vulnerability Assessment Scripts</h4>
                    <p class="text-xs sm:text-sm transition-colors" :class="isDark ? 'text-gray-400' : 'text-gray-600'">Collection of Python scripts for automated penetration testing</p>
                </div>
                <a href="https://github.com/The-Peacemaker/scripts" target="_blank" rel="noopener noreferrer" 
                   class="text-xs sm:text-sm font-medium hover:underline transition-colors flex-shrink-0 ml-2" 
                   :class="isDark ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-700'">
                    View →
                </a>
            </div>
            ...
            <div class="flex justify-between items-center p-3 sm:p-4 rounded-lg transition-colors" :class="isDark ? 'bg-gray-800' : 'bg-gray-50'">
                <div>
                    <h4 class="font-medium text-sm sm:text-base transition-colors" :class="isDark ? 'text-white' : 'text-gray-900'">College Management System</h4>
                    <p class="text-xs sm:text-sm transition-colors" :class="isDark ? 'text-gray-400' : 'text-gray-600'">Web-based student information management system</p>
                </div>
